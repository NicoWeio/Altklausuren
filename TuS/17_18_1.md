...
10 Meter tief in Wasser abgesenkt, das sich in vollständigem thermischen
...
$$E = p_0 V \exp\left(\frac{2S}{2k_\text{B}N}\right)$$ gehörige freie
Energie in ihren natürlichen Variablen. $p_0$ ist hierbei eine
einheitenbehaftete Konstante.
...
$\left\langle\mathcal{H_\text{pot}}\right\rangle$.\
...
$$\kappa_T = -\frac{1}{V}\left.\frac{\partial V}{\partial \rho}\right\rvert_{T}$$
...
also in Matrix-Darstellung:
$$\begin{pmatrix}0 & 0 \\ 0 & \epsilon_2\end{pmatrix} \;.$$
...
$$\varepsilon_\text{F} = \frac{1}{\alpha}\left(3\pi^2\hbar^3\frac{N}{V}\right)^{\gamma/3}$$
